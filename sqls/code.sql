CREATE TABLE CODE_BOOK.OP_CODES (
...
CREATE OR REPLACE TRIGGER on_op_codes_update BEFORE
UPDATE ON CODE_BOOK.OP_CODES FOR EACH ROW BEGIN :new.updated_at := CURRENT_TIMESTAMP;
END;